...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
	...
	else if ([elementName isEqualToString:@"admin1"])
	{
		self.contentOfCurrentBlock = [NSMutableString string];
	}
	else if ([elementName isEqualToString:@"admin2"])
	{
		self.contentOfCurrentBlock = [NSMutableString string];
	}
...
{     
	...
	if ([elementName isEqualToString:@"admin1"])
	{
		self.currentItem.addr1 = self.contentOfCurrentBlock;
	}
	else if ([elementName isEqualToString:@"admin2"])
	{
		self.currentItem.addr2 = self.contentOfCurrentBlock;
	}
