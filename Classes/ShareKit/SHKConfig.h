...
#define SHKFacebookKey				@"290910214302035"
#define SHKFacebookSecret			@"2bccca818ebbcdd28137c9dd0254bbfd"
 ...
 */
#define SHKTwitterConsumerKey		@"oOgwCuDxAYuZVvvoqsTejw"
#define SHKTwitterSecret			@"SnxiAdP9bKNMsT4QVmpaan73gTTycQsgMJGayVxkU"
#define SHKTwitterCallbackUrl		@"http://www.iappsologic.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
